...
- Added v0.10 Workflow Query Facade Phases 1-2 with frozen privacy-safe read models, bounded pagination, structural read ports, and a deterministic immutable in-memory facade with filters, stable ordering, safe errors, and no runtime-internal dependencies.
